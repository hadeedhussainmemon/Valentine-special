...
export async function POST(request) {
    try {
        await connectDB();
        const { sender_name, recipient_name, custom_message } = await request.json();
        ...
        const newProposal = await Proposal.create({ id, sender_name, recipient_name, custom_message });
